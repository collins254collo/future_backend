...
exports.sendMessage = async (req, res) => {
  try {
    ...
    const notifyYou = resend.emails.send({
      from: "Portfolio Contact <onboarding@resend.dev>", // use your verified sender domain later
    ...
    const autoReply = resend.emails.send({
      from: "Collins Wanjiru | Portfolio <onboarding@resend.dev>",
      to: email,
    ...
    await Promise.all([notifyYou, autoReply]);

    console.log(" Email sent to you and auto-reply sent to client.");
